...
define("underscore/underscore", (function (global) {
    return function () {
        var ret, fn;
        return ret || global._;
    };
...
define("backbone/backbone", ["underscore","jquery"], (function (global) {
    return function () {
        var ret, fn;
...
define('CSS',['jquery', 'underscore', 'backbone'], function($, _, Backbone){
...
define('Panel',['Block'], function(Block){ 
	var Panel = {}; 
...
define('jquery.hammer', ['jquery.hammer/jquery.hammer'], function (main) { return main; });

define("jquery.hammer/jquery.hammer", function(){});
...
define("less/less", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.less;
    };
}(this)));

define('Page',['Panel', 'jquery.hammer', 'less'], function(Panel, hammer, less){ 
	var Page = {}; 
...
define('Controller',['Block', 'Panel','Page', 'DefaultRouter', 'io', 'jquery.hammer'], function(Block, Panel, Page, Router, io){
...
define('Form',['Block'], function(Block){
	var Form = {}; 
...
define('AnimationForm',['Form'], function(Form){
	var AnimationForm = {}; 
...
define('BorderForm',['Form'], function(Form){
	var BorderForm = {}; 
...
define('Button',['Block'], function(Block){
...
define('ButtonForm',['Form'], function(Form){
	var ButtonForm = {}; 
...
define('ColorForm',['Form'], function(Form){
	var ColorForm = {}; 
...
define('ContentForm',['Form'], function(Form){
	var ContentForm = {}; 
...
define('Dialog',['Panel'], function(Panel){
	var Dialog = {}; 
	Dialog.Model = Panel.extend(); 
	return Dialog; 
}); 
define('DrawingPage',['Page', 'io'], function(Page, io){ 
	'use strict;' 
	var DrawingPage = {}; 
		...
		animate: function(){ 
			...
			if(page.keysPressed.left){ 
				page.$el.one('mousemove', function(ev){
					...
					controller.socket.emit('draw', {ev: {pageX: ev.pageX, pageY: ev.pageY}, state: page.brushSettings}); 
				}); 
			} 
...
define('ImageBlock',['Block'], function(Block){ 
	var ImageBlock = {}; 
...
define('PublishForm',['Form'], function(Form){ 
	var PublishForm = {}; 
...
define('TextBlock',['Block'], function(Block){ 
	var TextBlock = {}; 
...
define('TextForm',['Form'], function(Form){
	var TextForm = {}; 
...
define('TransformForm',['Form'], function(Form){
	var TransformForm = {}; 
...
if (!window['YT']) {var YT = {loading: 0,loaded: 0};}if (!window['YTConfig']) {var YTConfig = {};}if (!YT.loading) {YT.loading = 1;(function(){var l = [];YT.ready = function(f) {if (YT.loaded) {f();} else {l.push(f);}};window.onYTReady = function() {YT.loaded = 1;for (var i = 0; i < l.length; i++) {try {l[i]();} catch (e) {}}};YT.setConfig = function(c) {for (var k in c) {if (c.hasOwnProperty(k)) {YTConfig[k] = c[k];}}};var a = document.createElement('script');a.src = 'http:' + '//s.ytimg.com/yts/jsbin/www-widgetapi-vflMWcllz.js';a.async = true;var b = document.getElementsByTagName('script')[0];b.parentNode.insertBefore(a, b);})();};
define('youtube', ['youtube/iframe_api'], function (main) { return main; });

define("youtube/iframe_api", function(){});

define('VideoBlock',['Block', 'youtube'], function(Block, youtube){ 
	var VideoBlock = {}; 
...
require(['Controller', 'DefaultRouter', 'AnimationForm', 'Block', 'BorderForm', 'Button', 'ButtonForm', 'ColorForm', 'ContentForm', 'Dialog', 'DrawingPage', 'Form', 'ImageBlock', 'Page', 'Panel', 'PublishForm', 'TextBlock', 'TextForm', 'TransformForm', 'VideoBlock'], function(Controller, Router){
	//start module 
	console.log('oh heeeeey'); 
