...
define('Page',['Panel', 'jquery.hammer'], function(Panel){ 
	var Page = {}; 
...
define('DefaultRouter',['jquery', 'underscore', 'backbone'], function($, _, Backbone){
...
define('Controller',['jquery', 'underscore', 'backbone', 'less','Block', 'Panel','Page', 'DefaultRouter', 'io', 'jquery.hammer'], function($, _, Backbone, less, Block, Panel, Page, Router, io){
...
define('Dialog',['Panel'], function(Panel){
	var Dialog = {}; 
	Dialog.Model = Panel.Model.extend(); 
	Dialog.View = Panel.View.extend(); 
	return Dialog; 
}); 
